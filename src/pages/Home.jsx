...
const FILM = [
  ...
  { src: `${IMG}/film/agni.jpg`, alt: "Wedding ceremony portrait" },
...
const HALL_GALLERY_SLIDES = (() => {
  ...
  [
    ...
    [`${IMG}/film/agni.jpg`, "Ceremony portrait"],
          ...
          <div className="terms-panel">
            ...
            <div className="terms-body">
              <aside className="terms-side" aria-label="Terms navigation">
                ...
                <div className="terms-lang-chips" role="group" aria-label={termLoc.ui.langLabel}>
